...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-brand-100/80 via-background to-background">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-0 h-80 bg-[radial-gradient(circle_at_50%_0%,rgba(20,147,163,.24),transparent_66%)]"
      />
      <div
        aria-hidden="true"
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl">
      <div className="relative overflow-hidden rounded-[2rem] bg-white p-2 shadow-2xl shadow-brand-900/15 ring-1 ring-white">
        ...
        <img
          src="/employee-hero.webp"
          alt="موظف كيتعلم الإنجليزية باش يطور المسار المهني ديالو"
          width={1100}
          height={733}
          fetchPriority="high"
          loading="eager"
