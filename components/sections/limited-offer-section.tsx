  ...
  return (
    <section className="section-shell relative overflow-hidden bg-brand-900 text-white">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(60% 58% at 50% -5%, rgba(20,147,163,.42) 0%, transparent 62%), radial-gradient(42% 42% at 8% 70%, rgba(224,155,55,.28) 0%, transparent 60%), radial-gradient(38% 38% at 92% 75%, rgba(26,166,138,.24) 0%, transparent 65%)",
        }}
      />
